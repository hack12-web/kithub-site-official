...
@Component({
  selector: 'app-reveivention',
  templateUrl: './reveivention.component.html',
  styleUrls: ['./reveivention.component.scss']
})
export class ReveiventionComponent implements OnInit {
